...
import {Kanibo, Priotrize} from '../kanban-area/area/kanibo/kanibo.model';
...
const initialState: State = {
  section: {
    todo: {
      title: 'TODO',
      list: [
        new Kanibo('Sleep', 'Sleep in your Bed', 6, new Date(2018, 9, 13), null, new Priotrize(1, 1, 1, 1)),
        new Kanibo('Eat', 'Eat in kitchen something to stay alive', 7, new Date(2018, 8, 13), null, new Priotrize(1, 1, 1, 1)),
        new Kanibo('Relax', 'Relax your mind for a while', 8, new Date(2018, 5, 13), null, new Priotrize(1, 1, 1, 1))
      ],
      order: 1
    },
    ...
    inProgress: {
      title: 'INPROGRESS',
      list: [
        new Kanibo('Angular Kanban Board',
          'Develop a Kanban board to track over your multiple issues',
          4,
          new Date(2018, 1, 13),
          null,
          new Priotrize(1, 1, 1, 1)),
        new Kanibo('Java OCA', 'Oracle Certified Association Preperation', 5, new Date(2018, 3, 13), null, new Priotrize(1, 1, 1, 1))
      ],
      order: 2
    },
      ...
      list: [
        new Kanibo('Graduate from University',
          ...
          6,
          new Date(2018, 2, 13), null, new Priotrize(1, 1, 1, 1)),
      ],
      order: 3
    }
  },
  ...
  switch (action.type) {
    ...
    case KanbanActions.UPDATE_KANIBO:
      const updateOldKanibo = {
        ...
        priotrize: action.payload.priotrize,
        updateDate: new Date()
      };
